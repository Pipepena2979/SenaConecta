    ...
    <div class="modal-content">
      ...
      <?php if($_SESSION['rol'] == 1 OR $_SESSION['rol'] == 4){?>
        <?php if($contadorIns2 > 0){?>
            <form name="formEventoUpdate" id="formEventoUpdate" action="UpdateEventoCurso.php" class="form-horizontal" method="POST">
              <div class="card-body">
                <div class="row">
                  <div class="form-group col-md-6">
                   ...
                   <div class="form-group col-md-6">
                    <label for="enrubro" class="col-sm-12 control-label">Tipo de Rubro</label>
                    <select class="form-control" name="enrubro" id="enrubro">
                      <option value=""  selected disabled>Selecciona una opción</option>
                  ...
                  <div class="form-group col-md-6">
                    <label for="enDoc" class="col-sm-12 control-label">Nivel academico</label>
                    <input type="text" class="form-control" value="<?=$_SESSION['calendarioCurso'][0]['nom_nivel']?>" disabled>
                  </div>
                  <div class="form-group col-md-6">
                    <label for="enDoc" class="col-sm-12 control-label">Nombre de la titulacion</label>
                    <input type="text" class="form-control" value="<?=$_SESSION['calendarioCurso'][0]['denominacion_prog']?>" disabled>
                  </div>
          ...
          <form name="formEventoUpdate" id="formEventoUpdate" action="UpdateEventoCurso.php" class="form-horizontal" method="POST">
            <div class="card-body">
              <div class="row">
                ...
                <select class="form-control" name="eambiente" id="eambiente">
                  <option value=""  selected disabled>Selecciona una opción</option>
